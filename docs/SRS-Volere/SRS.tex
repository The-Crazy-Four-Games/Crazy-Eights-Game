...
\begin{itemize}
  ...
  \item Typical input devices: keyboard and mouse; keyboard-only interaction must be supported for main flows.
...
\subsubsection*{Fit criterion}
Acceptance when: (a) core flows run on supported browsers; (b) documented REST endpoints respond to auth and telemetry; (c) dev deployment runs end-to-end using provided Docker-compose with README steps validated by at least one tester.
