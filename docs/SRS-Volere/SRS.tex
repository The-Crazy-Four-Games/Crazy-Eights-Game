...
\subsection{Which Supported bases?}
  \begin{itemize}
    ...
    \item \textbf{Action:} No action assigned; discussion required.
...
\subsection{Unspecified issues:}
  \begin{itemize}
    \item Multiplayer mode: whether to implement in current phase or postpone to future release.
    \item Educational feedback: how to deeply explain Dozenal math within a card game.
    \item Game difficulty: balancing fun and learning value.
    \item Visual design theme: educational vs. playful aesthetic.
  \end{itemize}
